...
const string strMessageMagic = "Ekita Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Ekita
    bool fStrictPayToScriptHash = true; // Always active in Ekita
    ...
    int64 nValueOut = 0;
    unsigned int nSigOps = 0;
    int64_t nTxnFess = 4000000.00000000;
    BOOST_FOREACH(CTransaction& tx, vtx)
    {
    ...
    pindex->nMoneySupply = (pindex->pprev? pindex->pprev->nMoneySupply : 0) + nValueOut - nValueIn - nTxnFess;
    ...
    if (vtx[0].GetValueOut() > TianXia(pindex->nHeight, nFees, prevHash))
		return false;
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ekita", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "20140730";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1403927619;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1633555;
        if (false ) {
        ...
        assert(block.hashMerkleRoot == uint256("0xefb67e055ad927f1f85d1cee6a12262538fb9f7a660f5bc98480f7c0fe24120e"));//662dd4d3a997c34b02d5dfa52bf0f6ab4fd7849c0cc4912be16e136f23eced39"));
...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake)
{
    ...
    int64 nFees = 0;
    {
        ...
        if (pblock->IsProofOfWork())
            pblock->vtx[0].vout[0].nValue = TianXia(pindexPrev->nHeight+1, nFees, pindexPrev->GetBlockHash());
