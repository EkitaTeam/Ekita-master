#############################################################################
# Makefile for building: Ekita-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ?? 2 08:50:36 2014
# Project:  Ekita.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_UPNP=1 USE_IPV6=1 -o Makefile Ekita.pro
#############################################################################
...
Makefile: Ekita.pro  c:/Qt/4.8.6/mkspecs/default/qmake.conf c:/Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=1 USE_IPV6=1 -o Makefile Ekita.pro
